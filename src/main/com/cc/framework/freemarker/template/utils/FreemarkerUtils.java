...
public class FreemarkerUtils {
    ...
    private static final Resource CLASSPATH_RESOURCE = new ClassPathResource("/template/");
    private static final Resource STATIC_RESOURCE = new ClassPathResource("/static/");
    /** 默认模板路径 */
    ...
    static {
        ...
        try {
            ...
            defaultOutDir = STATIC_RESOURCE.getURL().getPath();
     ...
     * @param fillData      填充内容
     */
    public static TemplateOutInfo createTemplateFile(String templateDir, String templateName, String outDir, Long filename, Object fillData) {
        ...
        try {
            ...
            // 初始化输出文件
            String outFilePath = outDir + File.separator + filename + ".html";
     ...
     * @param fillData      填充内容
     */
    public static TemplateOutInfo createTemplateFile(String templateName, Long filename, Object fillData) {
        // 使用默认的文件地址
        return createTemplateFile(DEFAULT_TEMPLATE_DIR, templateName, DEFAULT_OUT_DIR, filename, fillData);
    }
